...
<div class="main">
<div class="content">
	<h2>Album Artifact</h2>
			<div class="section group">
			<br>
				<font size="3" color="#00003D" >
					  In the late-'90s, Little Big Town was still a little country band looking for their big break. 
					  They thought they found it with Mercury Records, but the label failed to produce any singles or albums for them. 
					  When they eventually signed with Sony's Monument label, they were caught in a hailstorm of criticism for a 
					  manufactured image that didn't really reflect who they were. That struggle to establish an identity lead the 
					  harmonizing team to write "Boondocks." <br>
